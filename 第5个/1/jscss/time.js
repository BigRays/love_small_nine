function showTime() { 
	...
	var startDate = new Date(2018, 8, 20, 15, 45, 0);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Small Nine:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----大神   2018-09-20</c>"; 
